...
dashboardPage(title="xMAPr - analyzing serological assays with high precission",
  ...
  dashboardSidebar(
    sidebarMenu(id="side.menu",
      ...
      h5("version 2.0.0",align="center"), # version ------
                          ...
                          fluidRow(
                            ...
                            box(
                              ...
                              column(width=3,
                                     ...
                                     selectInput(inputId = "data_proc_method",
                                                 label = "method for data processing:",
                                                 choices = c("hook+ubi","hook"),
                                                 selected = "hook",
                                                 multiple = F),
                                     bsPopover(id = "data_proc_method", 
                                               title = NULL, 
                                               content ="selection of fit processing: default is hook binding detection", 
                                               placement = "bottom", 
                                               trigger = "hover",
                                               options = NULL),
                                     numericInput(inputId = "data_proc_method_cutoff" ,
                                                  label = "ubi response ratio cutoff:",
                                                  value = 4),
                                     bsPopover(id = "data_proc_method_cutoff", 
                                               title = NULL, 
                                               content ="ratio cutoff for leave out iteration (to min. of 5 dilution stages) response calculation for resolving unspecific binding issues", 
                                               placement = "bottom", 
                                               trigger = "hover",
                                               options = NULL)
                              ),
