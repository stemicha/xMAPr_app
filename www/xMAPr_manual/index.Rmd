...
knitr::write_bib(c(
  .packages(), "bookdown", "knitr", "rmarkdown","plotly","ggsignif","factoextra","FactoMineR","RColorBrewer","gridExtra","ggrepel","tidyverse","rlang","data.table","minpack.lm","shinyFiles","shinyWidgets","shiny","shinyjs","magrittr","shinydashboard","shinycssloaders","scales","shinyBS","shinyalert","heatmaply","DT"
), "packages.bib")
```
